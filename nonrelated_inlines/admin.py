...
class NonrelatedInline(InlineModelAdmin):
    """
    Inline base class for models not explicitly related to the inline
    model.
    """
...
class NonrelatedStackedInline(NonrelatedInline, admin.StackedInline):
    def get_form_queryset(self, obj):
        raise NotImplementedError()
...
class NonrelatedTabularInline(NonrelatedInline, admin.TabularInline):
    def get_form_queryset(self, obj):
        raise NotImplementedError()
